...
OutputDir=__SOURCE_DIR__\dist\packages\windows
...
[Files]
Source: "__SOURCE_DIR__\dist\packages\windows\clarionet\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
